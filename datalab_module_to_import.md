...
| adapters_plotpy         | ❌   | Adapters/converters for PlotPy, guidata objects <-> Sigima objects       | Check consistency with `sigima.viz` (future feature)  | sigima, plotpy, guidata         |
...
| gui/actionhandler       | ✅⚠️   | Module handles app actions (menus, toolbars, context menu, ...)          |                                        | sigima, guidata, qt             |
