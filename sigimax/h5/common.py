...
"""
SigimaX Common tools for exogenous HDF5 format support
"""
...
def data_to_xy(data: np.ndarray) -> list[np.ndarray]:
    ...
    This is useful for importing data and creating a SigimaX signal with it.
